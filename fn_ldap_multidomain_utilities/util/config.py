...
"""Generate a default configuration-file section for fn_ldap_multidomain_utilities"""


def config_section_data():
    """
    Produce add the default configuration section to app.config,
    for fn_ldap_multidomain_utilities when called by `resilient-circuits config [-c|-u]`
    """

    config_data = u"""[fn_ldap_multidomain_utilities]
# Config para ldap_md_domain_name = domain1
...
# Config ldap_md_domain_name = anotherdomain
