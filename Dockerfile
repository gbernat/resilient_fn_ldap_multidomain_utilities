# docker build -t ibmresilient/fn_ldap_multidomain_utilities:1.0.0 -t ibmresilient/fn_ldap_multidomain_utilities:latest .

# Base image using Red Hat's universal base image (rhel 8) for python
FROM registry.access.redhat.com/ubi8/python-36:latest

ARG APPLICATION=fn_ldap_multidomain_utilities
